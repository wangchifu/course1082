...
@section('title','指定審「資優類」委員 | ')
@section('content')
@include('layouts.form_errors')
{{ Form::open(['route'=>'reviews.special2_user_store','method'=>'post']) }}
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            {{ Form::select('special2_user_id', $users,null, ['class' => 'form-control','required'=>'required', 'placeholder' => '--']) }}
        </td>
        <td>
