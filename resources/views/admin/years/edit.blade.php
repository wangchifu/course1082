        ...
        <div class="col-md-9">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">修改 {{ $year->year }} 年度</li>
                </ol>
            </nav>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['route'=>['years.update',$year->id],'method'=>'patch']) }}
                    <table>
                        <tr>
                            <td width="33%">
                                <div class="form-group">
                                    <label for="year">年度</label>
                                    {{ Form::text('year',$year->year,['class'=>'form-control','id'=>'year','maxlength'=>'3','readonly'=>'readonly']) }}
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    {{ Form::select('e1',$courses,$year->e1,['class'=>'form-control','id'=>'e1','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="e2">國小二年級</label>
                                    {{ Form::select('e2',$courses,$year->e2,['class'=>'form-control','id'=>'e2','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="e3">國小三年級</label>
                                    {{ Form::select('e3',$courses,$year->e3,['class'=>'form-control','id'=>'e3','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    {{ Form::select('e4',$courses,$year->e4,['class'=>'form-control','id'=>'e4','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="e5">國小五年級</label>
                                    {{ Form::select('e5',$courses,$year->e5,['class'=>'form-control','id'=>'e5','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="e6">國小六年級</label>
                                    {{ Form::select('e6',$courses,$year->e6,['class'=>'form-control','id'=>'e6','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                        </tr>
                        <tr bgcolor="#CCEEFF">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    {{ Form::select('j1',$courses,$year->j1,['class'=>'form-control','id'=>'j1','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="j2">國中二年級</label>
                                    {{ Form::select('j2',$courses,$year->j2,['class'=>'form-control','id'=>'j2','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for="j3">國中三年級</label>
                                    {{ Form::select('j3',$courses,$year->j3,['class'=>'form-control','id'=>'j3','maxlength'=>'3','required'=>'required']) }}
                                </div>
                            </td>
                        </tr>
                        <tr bgcolor="#FFCCCC">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step1_date1" width="276" name="step1_date1" required maxlength="10" value="{{ $year->step1_date1 }}">
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step1_date2" width="276" name="step1_date2" required maxlength="10" value="{{ $year->step1_date2 }}">
                                    <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                    <script>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step2_date1" width="276" name="step2_date1" required maxlength="10" value="{{ $year->step2_date1 }}">
                                    <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                    <script>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step2_date2" width="276" name="step2_date2" required maxlength="10" value="{{ $year->step2_date2 }}">
                                    <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                    <script>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step4_date1" width="276" name="step4_date1" required maxlength="10" value="{{ $year->step4_date1 }}">
                                    <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                    <script>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input id="step4_date2" width="276" name="step4_date2" required maxlength="10" value="{{ $year->step4_date2 }}">
                                    <script src="{{ asset('gijgo/js/messages/messages.zh-TW.js') }}"></script>
                                    <script>
